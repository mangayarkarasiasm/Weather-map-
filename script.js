...
let api=`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&units=metric&appid=9612ba6f71f521d5122a4f5abbbef848`;
...
function datahandler(data){
    const {description}=data.weather[0];//for index no. use [] bracket notation
